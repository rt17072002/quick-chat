...
const ChatContainer = () => {
  ...
  const { messages, selectedUser, setSelectedUser, sendMessage, setMessages, getMessages} = useContext(ChatContext);
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg'>
      ...
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500'>
        ...
        <img onClick={() => setSelectedUser(null)} src={assets.arrow_icon} alt="" className="md:block max-w-5 cursor-pointer" />
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          <label htmlFor="image">
            <img src={assets.gallery_icon} alt="" className='w-5 mr-4 cursor-pointer' />
          </label>
        </div>
